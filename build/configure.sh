...
install -D -m 0755 "$ROOT/launcher/escape-guard.py" "$CHROOT/usr/libexec/moonlightos-escape-guard"
...
install -D -m 0755 "$ROOT/scripts/moonlightos-stop-active-app" "$CHROOT/usr/libexec/moonlightos-stop-active-app"
