...
tagged upstream repositories. MoonlightOS does not bundle Sony, NVIDIA, Steam,
or other proprietary game/service binaries, credentials, keys, firmware from
unapproved sources, or user pairing material.

Names such as Moonlight, PlayStation, Sunshine, Intel, Dell, and Gamescope are
the property of their respective owners. This project is not endorsed by Sony
Interactive Entertainment, Moonlight, Dell, Intel, or Valve.
