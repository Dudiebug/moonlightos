...
chiaki-ng data persists below `/var/lib/moonlightos/home/.config`. Its AppImage
requires system libva, Vulkan, hidraw, and PipeWire, all included in the image.
...
or advertised in v0.1; remote-console routing is a separately reviewed future
feature.
